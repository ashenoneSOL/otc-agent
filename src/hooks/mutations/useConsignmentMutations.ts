...
/**
 * Wallet authentication headers for API requests
 * Generated by signing a message with the connected wallet
 */
...
async function createConsignment(input: CreateConsignmentInput): Promise<OTCConsignment> {
  ...
  // Remove walletAuth from body (it's sent in headers, not body)
  const { walletAuth: _walletAuth, ...bodyData } = input;

...
3.1 **Permitted Use**
You may use the Resources to develop, deploy, and manage projects based on the Eliza framework. You may not use the Resources to misrepresent affiliation with the Eliza project or Eliza Labs.
...
The Eliza framework is provided under its respective open-source license. Eliza Labs makes no claims to the framework or its associated trademarks.

4.2 **Documentation Content**
The content of these Resources, including explanations, examples, and related materials, is provided by Eliza Labs and is protected under applicable intellectual property laws. You may not redistribute or sell the Resources without explicit permission.

4.3 **Accuracy of Information**
Eliza Labs cannot assure the accuracy, completeness, or reliability of the information provided in these Resources, as it is collected from third-party sources. Users are encouraged to verify critical details independently.
...
5.1 **No Warranty**
The Resources are provided "as-is" and "as-available" without any warranties of any kind, express or implied. Eliza Labs does not warrant that the Resources will meet your requirements or that they will be free of errors or interruptions.

5.2 **Third-Party Framework**
The Eliza framework is an independent project. Eliza Labs is not responsible for any issues, defects, or limitations in the framework itself.

**6. Limitation of Liability**
------------------------------

6.1 **Use at Your Own Risk**
Your use of the Resources is at your own risk. Eliza Labs is not liable for any damages, direct or indirect, resulting from your use of the Resources or the Eliza framework.

6.2 **Limit of Liability**
To the fullest extent permitted by law, Eliza Labs liability is limited to the extent of any fees paid (if applicable) for access to these Resources.

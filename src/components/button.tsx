...
export const styles = {
	...
	solid: [
		...
		// Disabled
		"disabled:before:shadow-none disabled:after:shadow-none disabled:before:bg-opacity-50",
	],
	outline: [
		// Base
		"border-zinc-950/10 text-zinc-950 data-active:bg-zinc-950/[2.5%] data-hover:bg-zinc-950/[2.5%] hover:bg-zinc-950/[2.5%]",
		// Dark mode
...
type ButtonProps = (
	...
	| { color?: never; outline?: never; plain?: boolean }
) & {
	className?: string;

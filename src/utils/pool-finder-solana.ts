...
// Raydium CLMM (Concentrated Liquidity) Program
const RAYDIUM_CLMM_PROGRAM = new PublicKey(
	"CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK",
);

// Raydium CPMM Program (new constant product)
...
async function findMeteoraPools(
	...
	// Also try the standard pairs endpoint
	...
	// Also try on-chain discovery for standard AMM pools if API didn't find anything
	if (pools.length === 0) {

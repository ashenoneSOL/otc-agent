 ...
 * Tests critical user journeys from start to finish on Anvil
 */
...
test.describe('Complete User Journeys', () => {
  test('buyer flow: connect → negotiate → accept → pay', async ({ page, wallet }) => {
    console.log('\n💰 Testing Complete Buyer Flow on Base Chain\n');
    
    // 1. Connect wallet to Base
    console.log('1️⃣  Connecting wallet to Base...');
    await page.goto('/');
    ...
    console.log('   ✅ Wallet connected to Base');
  ...
  test('seller flow: connect → list tokens → monitor', async ({ page, wallet }) => {
    console.log('\n📝 Testing Complete Seller Flow on Base Chain\n');
  ...
  test('view my deals after purchase', async ({ page, wallet }) => {
    console.log('\n📊 Testing My Deals View on Base Chain\n');

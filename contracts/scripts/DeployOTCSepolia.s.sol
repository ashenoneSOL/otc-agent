...
/// @title DeployOTCSepolia
/// @notice Deploy token-agnostic OTC contract and RegistrationHelper to Base Sepolia
contract DeployOTCSepolia is Script {
    ...
    function run() external {
        ...
        vm.writeFile("deployments/testnet-evm.json", deploymentJson);
        console.log("Wrote deployment to deployments/testnet-evm.json");

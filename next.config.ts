        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' http://127.0.0.1:8545 http://localhost:8545 http://127.0.0.1:4444 ws://127.0.0.1:4444 http://localhost:4444 ws://localhost:4444 ws://127.0.0.1:8545 ws://localhost:8545 http://127.0.0.1:8899 http://localhost:8899 ws://127.0.0.1:8900 ws://localhost:8900 https://*.solana.com wss://*.solana.com https://*.helius-rpc.com https://*.drpc.org https://eth.merkle.io https://api.neynar.com https://farcaster.xyz https://client.farcaster.xyz https://warpcast.com https://wrpcd.net https://*.wrpcd.net wss://relay.farcaster.xyz https://auth.privy.io https://*.rpc.privy.systems https://explorer-api.walletconnect.com https://pulse.walletconnect.org https://api.web3modal.org https://*.walletconnect.com wss://*.walletconnect.com wss://relay.walletconnect.org wss://www.walletlink.org https://*.metamask.io https://*.coinbase.com https://api.developer.coinbase.com https://mainnet.base.org https://sepolia.base.org https://api.dexscreener.com https://*.dexscreener.com https://dlmm-api.meteora.ag https://app.meteora.ag https://*.meteora.ag https://api.raydium.io https://*.raydium.io https://api.coingecko.com https://pro-api.coingecko.com https://otcdesk.fun https://tradingdesk.fun https://*.vercel.app",
              "font-src 'self' data:",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",

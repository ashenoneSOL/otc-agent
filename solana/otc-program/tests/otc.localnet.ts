...
describe("otc localnet smoke", () => {
  ...
  it("initializes desk and deposits tokens", async () => {
    ...
    await program.methods
      ...
      .accounts({ desk: desk.publicKey, deskTokenTreasury, deskUsdcTreasury, tokenMint, usdcMint, owner: owner.publicKey, agent: agent.publicKey, payer: owner.publicKey, systemProgram: SystemProgram.programId, tokenProgram: TOKEN_PROGRAM_ID })
      .signers([owner, desk])
      .rpc();
